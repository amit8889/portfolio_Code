...
import RabbitMQ from '../../assets/Image/tech/RabbitMQ.svg'
import Redis from '../../assets/Image/tech/Redis.png'
import PubSub from '../../assets/Image/tech/pubsub.jpeg'
import Socket from '../../assets/Image/tech/socket.svg'
        ...
        <div className='technical_text ' data-aos="fade-right">
            ...
            <div className='database technical_heading'>
                ...
                <div className='datast_text_technical'>
                    <div className='bulletpoint'></div>
                    <a>
                        <span>RabbitMQ <img src={RabbitMQ} /></span>
                    </a>
                </div>
                <div className='datast_text_technical'>
                    <div className='bulletpoint'></div>
                    <a>
                        <span className='tech_name'>Redis <img width="40px" src={Redis} /></span>
                    </a>
                </div>
                ...
                <div className='datast_text_technical'>
                    <div className='bulletpoint'></div>
                    <a>
                        <span className='tech_name'>Socket.io <img width="40px" src={Socket} /></span>
                    </a>
                </div>
            </div>
