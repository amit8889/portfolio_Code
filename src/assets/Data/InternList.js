...
import PINNACLEWORKS from '../Image/Intern/Pinnacleworks.png'
export const Internlist = [
  {
    company: "Pinnacleworks Infotech (p) ltd",
    dec: `PinnacleWorks is a global provider of AI-Powered SaaS Based Products including SuperBot which empower businesses to move towards Smart Automation. The company has a renowned presence in the IT market with a large pool of clients from different sectors.`,
    img: PINNACLEWORKS,
    certi: "https://drive.google.com/file/d/1onhJhKzqR_tQYpg3PTpTCIZeTTpUr_Dv/view?usp=sharing",
    tech: ' NODE | EXPRESS | MONGODB | SWAGGER | RABBITMQ | REDIS | PUBSUB | SOCKET.IO',
    date: "01/July/2023 - Present",
    role: "Software Developer",
    time: "3 Months",
    cmpURL: "https://pinnacle.works/"
  ...
  },
  {
    ...
    June, 2023. It was a 2 months’ internship. 
